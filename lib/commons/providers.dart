...
List<SingleChildWidget> providerList = [
  ChangeNotifierProvider<NewAppointmentProvider>(
      create: (_) => locator<NewAppointmentProvider>()),
  ChangeNotifierProvider<AppointmentListProvider>(
      create: (_) => locator<AppointmentListProvider>()),
  ChangeNotifierProvider<AuthProvider>(create: (_) => locator<AuthProvider>()),
  ChangeNotifierProvider<DocumentListProvider>(
      create: (_) => locator<DocumentListProvider>()),
  ChangeNotifierProvider<UserListProvider>(
      create: (_) => locator<UserListProvider>()),
  ChangeNotifierProvider<NotificationProvider>(
      create: (_) => locator<NotificationProvider>()),
  ChangeNotifierProvider<MemoListProvider>(
      create: (_) => locator<MemoListProvider>()),
  ChangeNotifierProvider<AppointmentDetailProvider>(
      create: (_) => locator<AppointmentDetailProvider>()),
];
