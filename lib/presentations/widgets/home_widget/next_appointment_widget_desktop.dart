...
class NextAppointmentwidgetDesktop extends StatefulWidget {
  final String userId;
  const NextAppointmentwidgetDesktop({super.key, required this.userId});

  @override
  State<NextAppointmentwidgetDesktop> createState() => _NextAppointmentwidgetDesktopState();
}

class _NextAppointmentwidgetDesktopState extends State<NextAppointmentwidgetDesktop> {
